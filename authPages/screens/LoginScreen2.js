    ...
    <View className="w-full h-full bg-white">
      ...
      <View className="w-full h-[50%] bg-sky-400 ">
        <Animated.View entering={FadeInUp.delay(200).duration(1000).springify().damping(3)} style={styles.container} >
          <Text style={styles.text} className="text-white text-center text-2xl font-bold">LoginScreen</Text>
        </Animated.View>
      </View>
      <View className="mt-2">
        <View className="mx-4 space-y-4 flex items-center mt-5">
          ...
          <Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} className="w-full bg-black/5 rounded-2xl p-5 mb-3">
